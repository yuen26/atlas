package org.atlas.framework.persistence.jpa.product.config;
 ...
 */
@Configuration
@EntityScan(basePackages = "org.atlas.framework.persistence.jpa.product.entity")
@EnableJpaRepositories(
    basePackages = "org.atlas.framework.persistence.jpa.product.repository",
